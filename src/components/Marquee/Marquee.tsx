  ...
  const Marquee: FC<MarqueeProps> = forwardRef(function Marquee(
    ...
    return !isMounted ? null : (
      <div
        ...
        className={`${styles.rfmMarqueeContainer} ${className}`} // Using CSS Module class names
      >
        {gradient && <div style={gradientStyle} className={styles.rfmOverlay} />}
        <div
          className={styles.rfmMarquee} // Using CSS Module class names
          style={marqueeStyle}
          onAnimationIteration={onCycleComplete}
          onAnimationEnd={onFinish}
        >
          <div className={styles.rfmInitialChildContainer} ref={marqueeRef}>
            {Children.map(children, (child) => {
              return (
                <div style={childStyle} className={styles.rfmChild}>
                  {child}
                </div>
              );
            })}
        ...
        <div className={styles.rfmMarquee} style={marqueeStyle}>
